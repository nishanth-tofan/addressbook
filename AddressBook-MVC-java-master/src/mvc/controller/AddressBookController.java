...
public class AddressBookController {
   ...
   */
    ...
    /*public Boolean validate(){
        ...
        if(mobile.length()<=10)
        {
             JOptionPane.showMessageDialog(new JFrame(), "Enter correct 10 Digits","Inane error", JOptionPane.ERROR_MESSAGE);
        }
        else
        {
             valid = true;
                ...
                {
                     JOptionPane.showMessageDialog(new JFrame(), "ENTER NUMBERS ONLY","Inane error", JOptionPane.ERROR_MESSAGE);
                }
